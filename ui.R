  ...
  tabsetPanel(
              tabPanel("Home Page", 
                fluidPage(fluidRow(column(6, offset = 3, style = "background-color: #E8E8E8",
                  ...
                  p("With this application, you can fit a mixture model of multiple gaussians to data you upload or simulate. 
                    ...
                    \n For further information and a guide for use of this application, see the user manual.", style = "text-align: center;")
                ))),
                value = "home"),
              ...
              tabPanel("Upload Data", 
                fluidPage(fluidRow(column(6,
                  ...
                  numericInput("data.num.subpopulations", "Number of subpopulations", 
                               2, min = 1, max = 10, step = 1),
                  numericInput("data.max.times", "Maximum number of iterations", 1500, 
              ...
              tabPanel("Simulate Data", 
                ...
                column(3,
                  ...
                  numericInput("sim.std.dev", "Standard Deviation", 1, min = 0, 
                               max = 333, step = 0.01),
                ...
                column(3,
                  h3("Set Sample Size"),
                  numericInput("sim.sample.size", "Sample Size", 100, min = 10, 
                               max = 10000, step = 1),
                ...
                column(6,
                  plotOutput("sim.plot"),
                  h3("Set Mixture Model Parameters"),
                  numericInput("sim.num.subpopulations", "Number of subpopulations", 
                               2, min = 1, max = 10, step = 1),
                  numericInput("sim.max.times", "Maximum number of iterations", 
                               1500, min = 1, max = 5000, step = 1),
